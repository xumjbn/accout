...
BODIES = {
    ...
    'shirt': '<path d="M8 4L4.5 7.5 7 10l1-1v11h8V9l1 1 2.5-2.5L16 4a4 4 0 0 1-8 0z"/>',
    'basket': '<path d="M4 9h16l-1.5 9a2 2 0 0 1-2 1.7h-9A2 2 0 0 1 5.5 18L4 9z"/><path d="M8.5 9L12 3.5 15.5 9"/><path d="M9.5 13v3M14.5 13v3"/>',
...
CATEGORIES = {
    ...
    '旅行': ('plane', '#14B8A6'), '服饰': ('shirt', '#D946EF'), '日用': ('basket', '#0EA5E9'),
    '还款': ('repay', '#64748B'), '其他': ('dots', '#9CA3AF'),
